...
try:
   ...
   final_token = t["Token"]
   print ("\nCongratulations! This is your Google Keep Master Token - you only need to extract this once. Please copy and paste this token directly into the 'Google Keep Master Token' settings field in Obsidian. Google Keep Sync should work from now on!\n")
   print (final_token)
